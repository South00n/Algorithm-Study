...
public class BaekJoon_3003 {
	...
	public static void main(String[] args) {
		...
		int w_king = sc.nextInt();
		int w_queen = sc.nextInt();
		int w_rook = sc.nextInt();
		int w_bishop = sc.nextInt();
		int w_knight = sc.nextInt();
		int w_pawn = sc.nextInt();
		
		System.out.println((king - w_king) + " " + (queen - w_queen) + " " + (rook - w_rook) + " " + (bishop - w_bishop) + " " + (knight - w_knight) + " " + (pawn - w_pawn));
